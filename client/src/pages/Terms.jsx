  ...
  const content = {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "If you suspect that your account has been compromised or encounter any account-related issues that cannot be resolved through the app's built-in features, please contact the administrator at +62 823-3692-4926 for further assistance.",
      },
      {
        title: "Termination",
